...
namespace ReflectionPractice
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //}
            //CollectionLesson cL = new CollectionLesson();
            //cL.ArrExample();

            var listPersons = Person2.AddingItems(1000000);
            Console.WriteLine(listPersons.GetType().Name);

            Stopwatch sw = new Stopwatch();
            Console.WriteLine( listPersons.Count(p => p._Id % 2 == 0) );
            Console.WriteLine( listPersons.FirstOrDefault(c => c._internalNumber == "9999")?._Id);
